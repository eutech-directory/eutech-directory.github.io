...
def get_tools():
    ...
    cur.execute("""
        SELECT name, category, description, country, website, verified, COALESCE(featured, false) as featured, COALESCE(featured, false) as featured, COALESCE(featured, false) as featured, COALESCE(featured, false) as featured
